...
const SeatLayout = () => {
        ...
        {Array.from({length:count}, (_, i) => {
          ...
          return (
            <button 
              ...
              className={`h-8 w-8 flex items-center justify-center rounded-md border border-primary/60 
                text-gray-300 hover:bg-primary/20 transition
  ...
  return show ? (
    ...
    py-[120px] md:pt-[200px]'>
      {/* Available Timing */}
      <div className='w-60 bg-primary/10 border border-primary/20
      rounded-lg py-10 g-max md:sticky md:top-[120px]'>
