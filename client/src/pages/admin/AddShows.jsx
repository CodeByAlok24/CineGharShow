        ...
        <div className='overflow-x-auto pb-4'>
          <div className='group flex flex-wrap gap-4 mt-4 w-max'>
           ...
           <div className='mt-8'>
            ...
            <div className='inline-flex items-center gap-2 border-gray-600
            ...
            <div className='mt-6'>
              ...
              <div className='inline-flex gap-5 border border-gray-600 p-1 pl-3 rounded-lg'>
                ...
                className='outline-none rounded-md'/>
                  <button onClick={handleDateTimeChange} className='bg-primary/80 text-white px-3 py-2 text-sm rounded-lg hover:bg-primary cursor-pointer'>
                  Add Time
                </button>
              </div>
            </div>
