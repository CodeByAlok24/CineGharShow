...
const Navbar = () => {
  ...
  const navigate = useNavigate()   // ✅ will use this instead
  ...
  return (
    <div className='fixed top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5'>
      ...
      {/* Navigation Links */}
      <div className={`ml-6 max-md:absolute max-md:top-0 max-md:left-0 max-md:font-medium 
            ...
            <UserButton>
              <UserButton.MenuItems>
                <UserButton.Action
                  ...
                  onClick={() => navigate('/my-bookings')}   // ✅ fixed here
                />
              </UserButton.MenuItems>
            </UserButton>
          )
